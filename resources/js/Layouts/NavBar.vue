        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SMART
                        ATTENDENCE</span>
                </a>
            ...
            <div class="flex items-center lg:order-2">
                ...
                <button @click="toggleTheme"
                    ...
                    <svg v-show="isDarkTheme" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="button"
                    class="flex items-center justify-center mx-3 text-sm bg-gray-800 text-white rounded-full w-8 h-8 md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
...
const initials = computed(() => {
    const nameParts = page.props.auth.user.name.split(' ');
