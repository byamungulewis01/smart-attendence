...
const submitForm = () => {
    if (mode.value === 'create') {
        ...
        form.put(route('courses.update', selectedCourse.value.id), {
            onSuccess: () => closeModal(),
        });
    }
};
...
watch(
    search,
    debounce((q) => router.get(route('courses.index'), { search: q }, { preserveState: true }), 500)
);
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <form @submit.prevent="submitForm" class="p-4 md:p-7">
                                        ...
                                        <button type="submit"
                                            ...
                                            {{ mode === 'create' ? 'Add new course' : 'Update course' }}
                                        </button>
                                    </form>
                                </div>
                            </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Registered Date</th>
                            ...
                            <template v-if="courses.data.length > 0">
                                <tr v-for="(course, index) in courses.data" :key="course.id"
                                    ...
                                    <td class="px-4 py-3">{{ new
                                        Date(course.created_at).toLocaleDateString('en-US', {
                                            month: 'long', day:
                                    ...
                                    <td v-if="$page.props.auth.user.role !== 'teacher'" class="px-4 py-3 flex items-center justify-end gap-2">
                                        ...
                                        <button type="button" @click="destroyRow(course.id)"
